...
where
    ...
    P: FMTProperties + AssociationProperties,
{
    fn weight_functions(&self, temperature: N) -> WeightFunctionInfo<N> {
        let p: &P = &self.parameters;
        let r = AssociationProperties::hs_diameter(p, temperature) * 0.5;
    ...
    fn calculate_helmholtz_energy_density(
        ...
        let diameter = AssociationProperties::hs_diameter(p, temperature);
