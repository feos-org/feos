use crate::association::{AssociationParameters, AssociationProperties, AssociationRecord};
use conv::ValueInto;
...
impl AssociationProperties for PcSaftParameters {
    ...
    fn weighted_densities<D: num_dual::DualNum<f64>>(
        ...
        let n2 = (&state.partial_density * &self.m * &r * &r).sum() * 4.0 * PI;
        let n3 = (&state.partial_density * &self.m * &r * &r * &r).sum() * 4.0 * FRAC_PI_3;
        [n2, n3]
    }
}
